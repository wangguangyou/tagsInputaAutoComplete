...
layui.define(['jquery', 'laytpl'], function (exports) {
  ...
  Class.prototype.init = function () {
    var that = this
      ...
      input = '<input type="text" placeholder="' + options.placeholder + '" class="layui-input">';
  ...
  Class.prototype.events = function () {
    ...
    var inputEvent = function () {
      ...
      if (options.autoComplete) {
        ...
        var left = elemdom.getBoundingClientRect().left
        var top = elemdom.getBoundingClientRect().top
  ...
  //加载组件所需样式
  layui.link(layui.cache.base + 'tagsInputAutoComplete/tagsInputAutoComplete.css');
